...
void DrawingCanvas::mousePressEvent(QGraphicsSceneMouseEvent *mouseEvent)
{
    ...
    case AddArrow:
        ...
        break;
    case AddBond:
        bondline = new QGraphicsLineItem(QLineF(mouseEvent->scenePos(), mouseEvent->scenePos()));
    ...
    case Select:
        ...
        if (items(mouseEvent->scenePos()).size()) {
            ...
            selectionRectangle = new QGraphicsRectItem(
                QRectF(mouseEvent->scenePos().x(), mouseEvent->scenePos().y(), 0, 0));
...
void DrawingCanvas::mouseMoveEvent(QGraphicsSceneMouseEvent *mouseEvent)
{
    ...
    case Select:
        if (selectionRectangle != 0) {
            ...
            QRectF newRect(QRectF(mouseOrigin.x(),
                                  mouseOrigin.y(),
