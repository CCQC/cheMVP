...
class Label : public QGraphicsTextItem
{
  ...
  public:
    enum LabelType {
        BondLabelType = UserType + BONDLABELTYPE,
    ...
    static Label *
    deserialize(QXmlStreamReader *reader, DrawingInfo *drawingInfo, QGraphicsScene *scene);
  ...
  private:
    ...
    class FontFormatTuple
    { // Holds the character range for a specific font. Credit: Jesse Yates
      public:
        int start, end;
        QString format;

        FontFormatTuple(QString f, int s, int e)
        {
            format = f;
            start = s;
            end = e;
        };
        static bool compareTo(FontFormatTuple *first, FontFormatTuple *second)
        {
        ...
        static FontFormatTuple *deserialize(QXmlStreamReader *reader)
        {
            ...
            return new FontFormatTuple(a.value("format").toString(),
                                       a.value("start").toString().toInt(),
                                       a.value("end").toString().toInt());
        };
    };
};
